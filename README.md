...
- [How to contribute](#how-to-contribute)
  ...
  - [Contributor conventions / rules](#contributor-conventions--rules)
    ...
    - [`git`](#git)
    - [`java`](#java)
    - [Code generation tool use.](./posts/Code_generation_attributions.md)
  - [Sponsor](#sponsor)
    - [Escrow](#escrow)
...
- [`./posts/Ultrasound_Pointclouds.md`](./posts/Ultrasound_Pointclouds.md) is "**Ultrasound acoustic tools (+ source code which measures echos of numerous transducers to produce volumetric pointclouds of surfaces)**".
...
- [`./posts/NaturalPhysicsFormulas.md`](./posts/NaturalPhysicsFormulas.md) lists numerous skeleton physics formulas, plus discusses how to use thus for sims.
- [`./posts/Howto_utopian_communism.md` ](./posts/Howto_utopia_communism.md) is "**How to replace world governments with trust for humans to contribute, plus the autonomous tools which can mass-produce food+houses so that less trust is required in fellow humans: utopian communism**".
- [`./posts/AutonomousLogHouseConstructionSystem.md`](./posts/AutonomousLogHouseConstructionSystem.md)
- [`./posts/smart_grass_article.md`](./posts/smart_grass_article.md) says how to produce grass which grows to 2 inches. **Notice**: [was produced through *Google AI Mode*](https://share.google/aimode/AQrR4bguWPkS27bqB), so [careful how you use this](./posts/ConsumerWarnings/Warning_AI_is_not_good_for_humans_to_use.md).
...
### Affiliates
You can use [_Capital 1_'s affiliate program](https://www.capitalone.com/bank/referrals/checking300/friend/?referralCode=06BEGSDPR&programCode=RAFOFFER300) to support `SusuPosts` (the revenue allows to publish more for you).
